...
const Pagination: React.FC<Props> = ({ maxNumber, onChange }) => {
  ...
  const Buttons = Array.from({ length: maxNumber }, (_, i) => {
    ...
    return (
      <button
        className="text-cw-purple-400 disabled:text-cw-grey-400 p-2 pointer w-[30px] h-[30px] flex items-center justify-center transition duration-150 ease-in-out"
  ...
  return (
    <div className="flex items-center justify-center gap-2">
      ...
      >
        <DobleArrowLeft color={currentPage === 1 ? "fill-cw-grey-400" : "fill-cw-purple-400"} />
      </button>
      <button
        className="bg-cw-grey-850 border border-cw-grey-400 rounded-[6px] w-[30px] h-[30px]  flex items-center justify-center transition duration-150 ease-in-out"
        ...
        disabled={currentPage === 1}
      >
        <ArrowLeft color={currentPage === 1 ? "fill-cw-grey-400" : "fill-cw-purple-400"} />
      </button>
      {Buttons}
      <button
        className="bg-cw-grey-850 border border-cw-grey-400 rounded-[6px]  w-[30px] h-[30px] flex items-center justify-center transition duration-150 ease-in-out"
      ...
      >
        <ArrowRight color={currentPage === maxNumber ? "fill-cw-grey-400" : "fill-cw-purple-400"} />
      </button>
      <button
        className="bg-cw-grey-850 border border-cw-grey-400 rounded-[6px]  w-[30px] h-[30px] flex items-center justify-center transition duration-150 ease-in-out"
        ...
        disabled={currentPage === maxNumber}
      >
        <DobleArrowRight color={currentPage === maxNumber ? "fill-cw-grey-400" : "fill-cw-purple-400"} />
      </button>
    </div>
  );
};
