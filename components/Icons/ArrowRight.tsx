...
const ArrowRight: React.FC<IconsCommonProps> = ({ color = "fill-cw-grey-400", className }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="6" height="12" fill="none" viewBox="0 0 6 12" className={className}>
      <path
        className={color}
