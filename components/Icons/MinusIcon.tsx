...
const MinusIcon: React.FC<IconsCommonProps> = ({ color = "fill-cw-grey-400", ...props }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="6" height="3" fill="none" viewBox="0 0 6 3" {...props}>
      <path
        className={color}
